...
while True:
    ...
    # Winning conditions, this will check whether every slot in any row is the same. If so the current player has won!
    if (
        ...
        # This means the while loop will not be repeated and the code below its indentation will run.
        break
...
# Any code here will be run after the game has finished
